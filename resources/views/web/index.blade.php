  ...
  <section>
    ...
    <div class="container-fluid">
      <div class="row cs_gap_y_30">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="cs_product cs_style_1">
              <div class="cs_product_thumb position-relative">
                ...
                @else
                  <img src="web/assets/img/product1.png" alt="{{ $product->name }}" class="w-100">
                @endif
              ...
              <div class="cs_product_info text-center">
                ...
                <p class="cs_product_category cs_fs_14 cs_medium cs_accent_color mb-0">
                  {{ $product->category->name ?? 'Uncategorized' }}
                </p>
                <div class="cs_product_price cs_fs_18 cs_semibold">${{ number_format($product->price, 2) }}</div>
                <div class="cs_product_stock cs_fs_12 cs_medium {{ $product->stock > 0 ? 'cs_green_color' : 'cs_red_color' }}">
        ...
        @else
          <div class="col-12">
            <div class="cs_empty_state text-center py-5">
              <div class="cs_empty_icon mb-4">
                <svg width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" style="color: #e2e8f0;">
                  <path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path>
                  <line x1="7" y1="7" x2="7.01" y2="7"></line>
                </svg>
              </div>
              <h3 class="cs_fs_32 cs_bold mb-3" style="color: #4a5568;">No Featured Products Yet</h3>
              <p class="cs_fs_18 mb-4" style="color: #718096; max-width: 500px; margin: 0 auto;">
                We're working hard to bring you amazing featured products. Check back soon for exciting new arrivals!
              </p>
              <div class="cs_empty_decoration">
                <div class="cs_sparkle" style="position: absolute; top: 20%; left: 20%; color: #fed7d7; font-size: 24px;">✨</div>
                <div class="cs_sparkle" style="position: absolute; top: 30%; right: 25%; color: #bee3f8; font-size: 20px;">⭐</div>
                <div class="cs_sparkle" style="position: absolute; bottom: 20%; left: 30%; color: #d6f5d6; font-size: 18px;">💫</div>
              </div>
            </div>
          </div>
        @endif
...
Our Bali Jewelers Collection reflects our commitment to elegance, craftsmanship, and beauty. Adorn yourself with pieces that shine as bright as you do.
      ...
      @else
        <div class="container">
          <div class="cs_empty_state text-center py-5">
            ...
            <h3 class="cs_fs_32 cs_bold mb-3" style="color: #4a5568;">No New Products Added Yet</h3>
            <p class="cs_fs_18 mb-4" style="color: #718096; max-width: 500px; margin: 0 auto;">
              Our team is busy curating fresh new products for you. Stay tuned for the latest additions to our collection!
            </p>
            <div class="cs_coming_soon_badge" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 24px; border-radius: 25px; font-weight: 600; margin-top: 20px;">
              🚀 Coming Soon
            </div>
            <div class="cs_empty_decoration" style="position: relative;">
              <div class="cs_sparkle" style="position: absolute; top: -50px; left: -60px; color: #fed7d7; font-size: 24px;">🎉</div>
              <div class="cs_sparkle" style="position: absolute; top: -30px; right: -80px; color: #bee3f8; font-size: 20px;">🛍️</div>
              <div class="cs_sparkle" style="position: absolute; bottom: -40px; left: -40px; color: #d6f5d6; font-size: 18px;">✨</div>
            </div>
          </div>
        </div>
      @endif
  ...
  <div class="container">
    <div class="cs_slider">
      <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="2000" data-center="0"
        ...
        <div class="cs_slider_wrapper">
          <div class="slick_slide_in">
            <div class="cs_partner_logo">
              <img src="web/assets/img/brand_1.svg" alt="Partner Logo">
            </div>
          </div>
          <div class="slick_slide_in">
            <div class="cs_partner_logo">
              <img src="web/assets/img/brand_2.svg" alt="Partner Logo">
            </div>
          </div>
          <div class="slick_slide_in">
            <div class="cs_partner_logo">
              <img src="web/assets/img/brand_3.svg" alt="Partner Logo">
            </div>
          </div>
          <div class="slick_slide_in">
            <div class="cs_partner_logo">
              <img src="web/assets/img/brand_4.svg" alt="Partner Logo">
            </div>
          </div>
          <div class="slick_slide_in">
            <div class="cs_partner_logo">
              <img src="web/assets/img/brand_5.svg" alt="Partner Logo">
            </div>
          </div>
          <div class="slick_slide_in">
            <div class="cs_partner_logo">
          ...
          <div class="cs_slider_wrapper">
            ...
            <div class="slick_slide_in">
              <div class="cs_testimonial cs_style_1 text-center">
                ...
                <div class="cs_testimonial_user">
                  <div class="cs_avatar_thumb">
                    <img src="web/assets/img/user2.png" alt="Avatar">
                  </div>
            ...
            <div class="slick_slide_in">
              <div class="cs_testimonial cs_style_1 text-center">
                ...
                <div class="cs_testimonial_user">
                  <div class="cs_avatar_thumb">
                    <img src="web/assets/img/user3.png" alt="Avatar">
                  </div>
